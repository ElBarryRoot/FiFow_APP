...
const success = new Set(['ACTIVE', 'AVAILABLE', 'APPROVED', 'PUBLISHED', 'SUCCEEDED', 'COMPLETED', 'RESOLVED', 'READY_FOR_HANDOVER', 'RECEIVED', 'SOLD'])
...
const danger = new Set(['FAILED', 'REJECTED', 'BANNED', 'DISPUTED', 'HIDDEN', 'BLOCKED', 'REFUND_PENDING'])
