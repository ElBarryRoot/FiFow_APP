...
export default function Input({ icon: Icon, right, className, inputClassName, ...props }) {
  return (
    <label className={cn('flex h-14 items-center gap-3 rounded-lg border border-fifow-border bg-white px-4 transition focus-within:border-fifow-primary focus-within:ring-4 focus-within:ring-violet-100', className)}>
