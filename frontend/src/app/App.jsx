...
const ReportConversation = lazy(() => import('../pages/support/ReportConversation.jsx'))
    ...
    <AnimatePresence mode="wait" initial={false}>
      ...
      >
        <Suspense fallback={<PageLoader />}>
          ...
          <Route path="/messages/:id/report" element={<ProtectedRoute><ReportConversation /></ProtectedRoute>} />
