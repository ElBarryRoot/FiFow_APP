    ...
    <UserPageShell title="Messages" eyebrow="Négociations" subtitle="Retrouvez vos échanges, offres et photos au même endroit.">
      <div className="grid gap-6 lg:grid-cols-[420px_1fr]">
        <aside className="space-y-4">
          <p className="mb-3 text-sm font-semibold text-fifow-secondary">{conversationsQuery.data?.unreadCount || 0} message(s) non lu(s)</p>
