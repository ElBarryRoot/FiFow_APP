  ...
  return (
    <header className="sticky top-0 z-40 border-b border-fifow-border/80 bg-white/95 backdrop-blur-xl">
      <div className="marketplace-container">
        <div className="flex min-h-14 items-center gap-1.5 lg:min-h-[68px] lg:gap-4">
          {showBack ? (
          ...
          {showSearch ? (
            <div className="hidden min-w-0 flex-1 lg:block">
              <SearchBar compact live className="mx-auto max-w-2xl" defaultValue={searchDefaultValue} onSubmit={submitSearch} />
            </div>
        ...
        {showSearch && mobileSearch ? (
          <div className="pb-2.5 lg:hidden">
            <SearchBar actionIcon={SlidersHorizontal} live onAction={onFilters} defaultValue={searchDefaultValue} onSubmit={submitSearch} />
          </div>
        ) : null}
