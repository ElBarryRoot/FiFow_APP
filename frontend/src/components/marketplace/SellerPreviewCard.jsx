...
export default function SellerPreviewCard({ seller }) {
  ...
  return (
    <Link to="/seller/mamadou" className="flex w-full items-center gap-3 rounded-lg border border-fifow-border bg-slate-50/70 p-3 text-left transition-colors hover:border-violet-200 hover:bg-fifow-lavender/40">
      <img src={seller.avatar || '/assets/avatar-mamadou.svg'} alt="" className="h-12 w-12 rounded-full bg-white object-cover" />
