      ...
      {canCancel || canDispute ? (
        <div className="border-t border-fifow-border pt-4">
          ...
          <div className="mt-3 grid gap-2">
            ...
            {canDispute ? <Button type="button" variant="danger" icon={AlertTriangle} disabled={busy} className="w-full bg-gradient-to-r from-red-600 to-rose-500 shadow-sm shadow-red-200 hover:from-red-700 hover:to-rose-600" onClick={() => onReasonAction('dispute')}>Signaler un problème avec cette commande</Button> : null}
          </div>
        </div>
      ) : null}
    </div>
