...
export const adminApi = {
  ...
  disputes: {
    list: (filters) => list('/admin/disputes', filters),
    detail: (id) => data(`/admin/disputes/${id}`),
    assign: (id) => data(`/admin/disputes/${id}/assign`, { method: 'PATCH' }),
    resolve: (id, input) => data(`/admin/disputes/${id}/resolve`, { method: 'PATCH', body: input }),
  },
